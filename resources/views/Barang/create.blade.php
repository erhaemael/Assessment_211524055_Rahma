...
<form action='{{ url('barang') }}' method='post'>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='KodeBarang' value="{{ old('KodeBarang') }}" id="KodeBarang">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="NamaBarang" class="col-sm-2 col-form-label">Nama Barang</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name='NamaBarang' value="{{ old('NamaBarang') }}" id="NamaBarang">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='HargaSatuan' value="{{ old('HargaSatuan') }}" id="HargaSatuan">
            </div>
        </div>
        <div class="mb-3 row">
